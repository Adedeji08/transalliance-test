...
const partner = () => {
  return (
    <div className="bg-white/20 backdrop-blur-md shadow-2xl rounded-lg px-4 pt-10 pb-20 flex flex-col flex-wrap justify-center items-start border-2 mx-auto lg:-mb-28 h-fit   lg:w-[70%] gap-6 z-30 absolute -bottom-[63rem] lg:-bottom-[20rem]">
