  ...
  return (
    <section className="flex justify-center items-center flex-col">
      ...
      <div className="flex justify-end w-[50%]">
        <button className="relative flex items-center justify-between px-6 py-4 w-64 rounded-2xl bg-gradient-to-l from-[#D3BD00] from-10% via-[#5FB083] to-[#5FB083] shadow-lg text-white font-medium backdrop-blur-4xl bg-opacity-50 border border-gray-500">
